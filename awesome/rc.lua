...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,		  }, "f", function () awful.spawn("ulauncher") end,
    	      {description = "open ulauncher", group = "launcher"}),
    ...
    awful.key({ modkey, "Shift"   }, "space", function () awful.layout.inc(-1)                end,
     ...
     awful.key({ modkey 	  }, "z", function () awful.spawn("/home/caskla/bin/c++/Notify/Notify s") end,
    	      {description = "inc volume", group = "launcher"}),
        -- Layout manipulation
...
-- Options for different desktops
...
if ENABLE_SMART_BORDERS == true then
  client.connect_signal("request::titlebars", function(c) smartBorders.set(c, true, true) end)
